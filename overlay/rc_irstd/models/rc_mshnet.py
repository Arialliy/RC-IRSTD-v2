...
RC_MSHNET_ARCHITECTURE_VERSION = "rc-mshnet-v1"
...
class RCMSHNet(StructuredCanonicalMSHNet):
    ...
    def __init__(
        ...
        *,
        ...
        self.use_component_context = bool(use_component_context)
        self.use_risk_gate = bool(use_risk_gate)
        self.expose_branch_auxiliary = bool(expose_branch_auxiliary)
    ...
    def forward(
        ...
        *,
        ...
        logits, contrast_delta, component_delta, _ = self.fusion_head(
            ...
            component_enabled=self.use_component_context,
        )
...
def build_rc_mshnet(config: Mapping[str, object] | None = None) -> RCMSHNet:
    ...
    return RCMSHNet(
        ...
        use_contrast=bool(values.get("use_contrast", True)),
        use_component_context=bool(values.get("use_component_context", True)),
        use_risk_gate=bool(values.get("use_risk_gate", True)),
        expose_branch_auxiliary=bool(
