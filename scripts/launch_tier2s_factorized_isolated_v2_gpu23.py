...
CONTAINER_NAME = "rc-irstd-tier2s-factorized-causal-audit-v2-gpu23"
SCHEMA = "rc-irstd-aaai27-tier2s-factorized-isolated-launch-intent-v2-gpu23"
...
def _verify_selected_gpus_idle(
    ...
    *,
    ...
    if non_idle or processes:
        raise RuntimeError(
            "selected physical GPU 2/3 must be idle before Tier2S launch"
        )
    return {
        "schema_version": "rc-irstd-aaai27-tier2s-gpu-idle-preflight-v2-gpu23",
        "verified": True,
