...
from scripts import export_tier2s_factorized_logits as tier2s_exporter
from scripts import register_aaai27_governance_v1 as governance_registrar
...
EXPORT_SCHEMA = "rc-irstd-tier2s-factorized-logit-export-v1"
PROTOCOL_SCHEMA = "rc-irstd-aaai27-tier2s-factorized-causal-audit-protocol-v1"
HANDOFF_SCHEMA = "rc-irstd-aaai27-tier2s-factorized-export-handoff-v1"
QUEUE_SCHEMA = "rc-irstd-aaai27-tier2s-fixed-two-lane-queue-v1"
QUEUE_SCHEDULER = "two_fixed_independent_fifo_lanes"
QUEUE_PHYSICAL_GPUS: tuple[int, ...] = (0, 1)
QUEUE_JOBS_PER_LANE = 9
RESULT_SCHEMA = "rc-irstd-aaai27-tier2s-factorized-audit-result-v1"
    ...
    *,
    ...
    for line_number, raw in enumerate(
        ...
        if (
            ...
            != "rc-irstd-aaai27-tier2s-scheduler-event-v1"
    ...
    for role, rows in (("start", starts), ("completion", completions)):
        ...
        for row in rows:
            ...
            observed[run_id] = (row.get("physical_gpu"), row.get("queue_index"))
