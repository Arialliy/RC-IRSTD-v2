...
SCHEMA_VERSION = "rc-irstd-tier2s-factorized-logit-export-v1"
PROTOCOL_ID = "tier2s_factorized_causal_audit_v1"
STREAM_HASH_SCHEMA = "rc-irstd-tier2s-factorized-stream-sha256-v1"
...
DEFAULT_PROTOCOL = PROJECT_ROOT / "configs/tier2s_factorized_causal_audit_v1.json"
...
PREREGISTRATION_SCHEMA = (
    "rc-irstd-aaai27-tier2s-factorized-preregistration-v1"
)
...
def validate_protocol(
    ...
    *,
    ...
    root = _lexical_absolute(project_root, name="project_root")
    expected = root / "configs/tier2s_factorized_causal_audit_v1.json"
